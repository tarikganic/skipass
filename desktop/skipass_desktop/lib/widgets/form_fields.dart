    ...
    return Column(
      ...
      children: [
        ...
        DropdownButtonFormField<T>(
          ...
          hint: Text(
            isEmpty
                ? (emptyHint ?? AppLocalizations.of(context)!.commonNoItemsAvailable)
                : (hint ?? AppLocalizations.of(context)!.commonSelect),
...
class AppDateField extends StatelessWidget {
  ...
  /// Kada nije zadano, koristi se generalna poruka "Odaberi".
  final String? hint;
      ...
      children: [
        ...
        InkWell(
          ...
          child: InputDecorator(
            ...
            child: Text(
              value == null ? (hint ?? l10n.commonSelect) : Formatters.date(value!),
